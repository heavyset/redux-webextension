...
exports.exposeStore = exports.connectedStore = exports.connectStore = undefined;
...
function connectStore(name = "default", portFactory = defaultPortFactory) {
  return new Promise((resolve, reject) => {
    let store = (0, _redux.createStore)(s => s, undefined, connectedStore(name, portFactory));
 ...
 *       happened.
 */
function connectedStore(name = "default", portFactory = defaultPortFactory) {
  return cs => (reducer, preloadedState) => {
    let wrappedReducer = (state, action) => {
    ...
    let subscribe = (...args) => guardResolve() && store.subscribe(...args);
    let replaceReducer = () => {
